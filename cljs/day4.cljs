     ...
     [:div.carousel-inner
      ...
      [:div.carousel-item {:data-bs-interval "5000"}
       ...
       (let [[A B X Y] (vec input)]
         [:div.carousel-caption.d-none.d-md-block
          [:h5 (str "Let elements be " [A B X Y] ".
      ...
      [:div.carousel-item {:data-bs-interval "5000"}
       [:svg.bd-placeholder-img.bd-placeholder-img-lg.d-block.w-100
        ...
        (if @part-1-visible?
          [:text {:x "50%" :y "30%" :fill "#999" :dy ".3em"} (str "Of " (count inputs) " there are " (part-1 inputs) " fully overlapping")]
          [:text {:x "50%" :y "30%" :fill "#999" :dy ".3em"} (str "Of " (count inputs) " there are " (part-2 inputs) " partially overlapping")])]
       (if @part-1-visible?
         [:div.carousel-caption.d-none.d-md-block
